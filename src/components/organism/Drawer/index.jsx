...
import ModalOpcao from '../../molecules/ModalOpcao'
	...
	return (
		<>
			...
			>
				...
				>
					...
					>
						...
						criada em 1903 por médicos paulistas, nos moldes do Instituto
						Pasteur de Paris.{' '}
					</Text>
					<Flex
						sx={{
			...
			<ModalInfo
				...
				setShowOp={setShowOp}
			></ModalInfo>
			<ModalOpcao id={'info'} isOpen={showOp} setShow={setShowOp}></ModalOpcao>
		</>
	)
}
